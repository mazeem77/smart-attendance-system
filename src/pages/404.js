...
function NoPage() {
  return (
    <main className="h-full w-full flex flex-col justify-center items-center mt-60 bg-[#121927]">
      ...
      <button className="mt-5">
        <Link className="relative inline-block text-sm font-medium text-red-500 group active:text-red-500 focus:outline-none focus:ring"
          ...
          <span className="relative block px-8 py-3 bg-[#121927] border border-current">
